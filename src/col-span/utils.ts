...
export const colSpanHelper = (arr:any[],fn:(pre:any,cur:any)=>boolean):{start:number,num:number}[] =>{
...
export const colSpanUtils = (arr:any[],dataIndex:string,fn:(pre:any,cur:any)=>boolean):{start:number,num:number}[]=>{
